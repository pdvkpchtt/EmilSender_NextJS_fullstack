  ...
  return (
    <div className="flex flex-col min-w-[20px] w-full">
      ...
      <input
        ...
        value={value}
        className={`px-[12px] p-[12px] text-[#2c2c2c] dark:text-white text-[14px] bg-[#f6f6f8] border-[0.5px] border-[#00afff] dark:bg-[#181d23] placeholder:text-[#bfbfbf] placeholder:select-none dark:placeholder:text-[#8f8f8f] transition duration-[250ms] placeholder:font-normal leading-[18px] tracking-[-0.015em] placeholder:leading-[18px] placeholder:tracking-[-0.015em]`}
        style={{
          borderRadius,
        }}
    ...
    <div className="flex flex-row gap-[10px] mx-auto">
      {[...Array(6)].map((_, key) => (
        <input
          ...
          onPaste={handlePaste}
          disabled={disabled}
          className={`px-[12px] w-[42px] p-[12px] text-[#2c2c2c] dark:text-white font-medium text-center text-[14px] bg-[#f6f6f8] border-[0.5px] border-[#00afff] dark:bg-[#181d23] transition duration-[250ms] leading-[18px] tracking-[-0.015em]`}
          style={{
            borderRadius,
          }}
        />
